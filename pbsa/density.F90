...
subroutine density_lvlset(memopt,outlvlset,outmlvlset,natom,xm,ym,zm,gox,goy,goz,h,&
   ...
   ! the sphere is now set to be max of cutfd and radi+2dprob
   ...
   insas(0:xm+1,0:ym+1,0:zm+1) = -int(sign(1.001d0, 1.0d0 - lvlset(0:xm+1,0:ym+1,0:zm+1)))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   do l = 1, nbnd
      i = iepsav(1,l); j = iepsav(2,l) ; k = iepsav(3,l)
         ...
         call project(xm,ym,zm,h,h,h,h,i,j,k,x,y,z,phi,x1,y1,z1,px,py,pz)
